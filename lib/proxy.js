...
function ReverseProxy(opts) {
  ...
  if (opts.cluster && cluster.isMaster) {
    ...
    proxy.on('proxyRes', function (proxyRes, req, res) {
      _this.enableCors(proxyRes, req, res);
      if (opts.ntlm) {
...
ReverseProxy.prototype.enableCors = function(proxyRes, req, res) {
  // proxyRes là response của target trả về cho proxy
  var headers = (proxyRes || req).headers;
